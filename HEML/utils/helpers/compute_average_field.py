...
def main():
    ...
    #)
    average_mats = []
    targets = ['./run1/cpet/', './run2/cpet/', './run3/cpet/', './run4/cpet/', './run5/cpet/']
    for target_folder in targets:
        ...
        save_numpy_as_dat(dict_meta_data, average_field, "/averages/{}_average_field.dat".format(target_folder))
        test_save_mat = mat_pull("./averages/{}_average_field.dat".format(target_folder))
