...
def write_topo(outdir_cpet, file_name, samples, bins, step_size, box_size, arg1, arg2, arg3, uuid=1): 
    options = open(f'{outdir_cpet}options_topology_{file_name}_{uuid}.txt', 'w+')
    options.write(f'align {arg1[0]}:{arg1[1]}:{arg1[2]} {nitrogen_dict["N1_xyz"][0]}:{nitrogen_dict["N1_xyz"][1]}:{nitrogen_dict["N1_xyz"][2]} {nitrogen_dict["N2_xyz"][0]}:{nitrogen_dict["N2_xyz"][1]}:{nitrogen_dict["N2_xyz"][2]}\n')
    ...
    for i in filelist:
        ...
        if(check_if_file_is_empty(i)): 
            ...
            if(not fail_cond):  
                ...
                write_topo(outdir_cpet, file_name, samples, bins, step_size, box_size, arg1, arg2, arg3, uuid=1)
                write_topo(outdir_cpet, file_name, samples, bins, step_size, box_size, arg1, arg3, arg2, uuid=2)
                write_topo(outdir_cpet, file_name, samples, bins, step_size, box_size, arg1, arg2, arg4, uuid=3)
                write_topo(outdir_cpet, file_name, samples, bins, step_size, box_size, arg1, arg4, arg2, uuid=6)
                write_topo(outdir_cpet, file_name, samples, bins, step_size, box_size, arg1, arg3, arg4, uuid=4)
                write_topo(outdir_cpet, file_name, samples, bins, step_size, box_size, arg1, arg4, arg3, uuid=5)
