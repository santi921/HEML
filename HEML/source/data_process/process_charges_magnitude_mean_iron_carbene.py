...
from HEML.utils.data import get_options, check_if_file_is_empty, get_fe_positions, get_c1_positions
    ...
    for i in filelist:
        ...
        if check_if_file_is_empty(i):
            ...
            try:
                ...
                print("c1 dict", c1_dict["id"], c1_dict["xyz"])
                print("mean position", np.mean([fe_dict["xyz"], c1_dict["xyz"]], axis=0))
